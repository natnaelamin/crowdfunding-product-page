...
function PledgeModal({isOpen, togglePledgeModal, toggleSuccessModal, handleRadio, 
  ...
  return (
    <div className='fixed inset-0 md:px-64 py-10'>
      <div className='px-5 md:px-10 py-10 bg-white w-full  
        ...
        <div>
          {data.map((item)=>(
            item.id === 0 ?  
              <div className={`mb-10 border ${item.id === newValue && 'border-cyan-500'} md:px-10 px-2 py-10 border-gray-300 rounded-lg`}>
                  ...
                  {item.id === newValue && 
                    <div className='md:flex justify-between py-5 mt-5 border-t '>
                      ...
                      <div className='md:flex grid grid-cols-2 md:gap-5 gap-1 relative'>
            ...
            : 
            <div key={item.id} className={`border border-gray-300 ${item.id === newValue && 'border-cyan-500'} rounded-lg px-5 py-10 mb-10`}>
                  ...
                  <div>
                    <div className='md:flex justify-between py-5 mt-5 border-t'>
                      ...
                      <div className='md:flex grid grid-cols-2 gap-5 relative'>
                        ...
                        <button onClick={handleSubmit} className='bg-teal-500 rounded-3xl px-5 text-white'>
                          {item.pledges <= 0 ? 'Out of Stock' : 'Continue'}</button>
                      </div>  
                    </div>
