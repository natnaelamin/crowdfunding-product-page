...
function SuccessModal({toggleSuccessModal, togglePledgeModal, decreasePledges, isSuccessOpen, totalBacked, newValue}) {
  ...
  return (
    <div className='px-96 py-40 fixed inset-0 bg-slate-400'>
